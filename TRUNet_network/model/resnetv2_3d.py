...
# in 2d
# size going into stdconv: torch.Size([20, 3, 224, 224])
# weights shape: torch.Size([64, 3, 7, 7])
# size going out of stdconv: torch.Size([20, 64, 112, 112])


# note: i don't know yet why there is such an issue with double and float datatypes!
# i just changed the types until it ran through...
